...
export const ArchivesView = ({ onClose }) => {
  ...
  return (
    <div className="archives-overlay" style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: `2px solid ${varGold}`, paddingBottom: '10px', marginBottom: '20px' }}>
        ...
        <button onClick={onClose} style={{ 
          ...
          padding: '5px 15px', cursor: 'pointer', fontSize: '1rem' 
        }}>閉じる</button>
      </div>
      ...
      {/* 下部：武勲録（合算ボーナス表示） */}
      <div style={{ marginTop: '20px', padding: '15px', border: `1px solid ${varGold}`, background: 'rgba(184, 154, 66, 0.05)' }}>
